...
// 8 
// Я не совсем понимаю как при такой записи можно вывести строку не в цикле, 
// на сколько я понял все что идет после условия будет отрабатывать в цикле, а мне надо только один раз вывести эту строку

for (let i = 0, a = 0, b = 1, c = 0, str = '01'; i <= 5; i++, c = a + b, a = b, b = c, str = str + c, console.log(str)) {}
// 9
